...
az keyvault create --name "othukeokv" --resource-group "othukeo-infra" --location uksouth
az keyvault secret set --vault-name "othukeokv" --name "tstateaccess" --value {$ACCOUNT_KEY}
az keyvault secret show --vault-name "othukeokv" --name "tstateaccess"
